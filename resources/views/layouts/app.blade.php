{{--
    Layout utama aplikasi — SATU-SATUNYA tempat script CDN Tailwind dan
    tailwind.config didefinisikan (Stage: Fondasi Design System & Layout
    Bersama).

    Halaman lain masih memuat CDN + config sendiri-sendiri untuk saat ini;
    migrasi mereka ke layout ini dikerjakan bertahap di stage berikutnya,
...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Inter:wght@300;400;500;600;700;800;900&family=Fraunces:wght@600..900&display=swap" rel="stylesheet">
            ...
            theme: {
                extend: {
                    ...
                    colors: {
                        ...
                        // Dulunya cuma ada sebagai variabel CSS --red / --red-bright.
                        brand: {
                            50:  '#fef2f2',
                            100: '#fee2e2',
                            200: '#fecaca',
                    ...
                    spacing: {
                        // Lebar sidebar guru/siswa — sebelumnya angka "260px"
                        // ditulis ulang manual di banyak file.
                        sidebar: '260px',
                    },
                    borderRadius: {
                        xs: '4px',
    ...
    {{-- Tempat halaman child menambahkan <style> khusus miliknya sendiri
         (mis. blok CSS besar yang belum sempat dipecah jadi komponen). --}}
    @stack('styles')
</head>
<body>
