...
<style>
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .sidebar-logo { padding: 28px 24px 22px; border-bottom: 1px solid var(--hairline); }
        .logo-wordmark {
            font-size: 0.78rem; font-weight: 900; letter-spacing: 3px; text-transform: uppercase;
            color: var(--color-ink); display: flex; align-items: center; gap: 9px;
        }
        .logo-icon {
        ...
        .sidebar-profile { padding: 20px 24px; border-bottom: 1px solid var(--hairline); }
        .profile-avatar {
            ...
            flex-shrink: 0; box-shadow: 0 0 18px rgba(122,46,46,0.3);
        }
        .profile-name {
        ...
        .profile-nip { font-family: var(--font-mono); font-size: 0.68rem; color: var(--color-ink-faint); margin-bottom: 7px; }
        .badge-role {
        ...
        .nav-item:hover { color: var(--color-ink); background: var(--surface-sunk); border-color: var(--hairline); }
        ...
        .topbar {
            ...
            background: rgba(250,247,242,0.88); backdrop-filter: blur(24px); -webkit-backdrop-filter: blur(24px);
            border-bottom: 1px solid var(--hairline); padding: 16px 36px;
            display: flex; align-items: center; justify-content: space-between; gap: 12px;
        }
        .topbar-left { display: flex; align-items: center; gap: 14px; min-width: 0; }
        .topbar-title {
            font-family: var(--font-mono);
            font-size: 0.8rem; font-weight: 700; color: var(--color-ink-faint); letter-spacing: 0.5px;
            white-space: nowrap; overflow: hidden; text-overflow: ellipsis;
        }
        ...
        .topbar-pill {
            ...
            color: var(--oxblood-ink); letter-spacing: 0.5px; white-space: nowrap; flex-shrink: 0;
        }
