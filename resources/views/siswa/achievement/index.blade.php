...
<style>
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        /* ── SIDEBAR + TOPBAR + MAIN-CONTENT ──
           FASE 4: seluruh CSS sidebar/topbar/main-content lokal (dulu duplikat
           260px, dengan icon set sendiri) DIHAPUS. Sekarang memakai shell
           bersama resources/css/components/dashboard-shell-siswa.css secara
           penuh — identik dengan siswa/dashboard.blade.php,
           siswa/profile/edit.blade.php, siswa/portfolio/create.blade.php &
           siswa/portfolio/edit.blade.php. Elemen topbar kanan tetap
           page-specific: .badge-pill (sama seperti pola di
           siswa/portfolio/create.blade.php & siswa/portfolio/edit.blade.php). */
        .badge-pill {
        ...
        /* Off-canvas sidebar mobile: sekarang ditangani sepenuhnya oleh
           shell bersama dashboard-shell-siswa.css (class .sidebar-open pada
           .sidebar, .active pada .sidebar-overlay) — lihat skrip di akhir
           file. Seluruh override lokal (.sidebar, .sidebar-overlay,
           .sidebar-logo-row, .sidebar-close-btn, .hamburger-btn,
           .topbar-left) DIHAPUS karena sudah disediakan shell. */
        ...
        /* Touch target minimal 44x44px (.nav-item & .btn-logout sudah
           44px lewat shell bersama, tidak perlu diulang di sini) */
        .btn-add, .btn-action-edit, .btn-action-file, .btn-action-delete { min-height: 44px; }
        ...
        /* Focus ring lembut untuk navigasi keyboard. .nav-item, .btn-logout,
           .hamburger-btn & .sidebar-close-btn tidak lagi diatur di sini —
           elemen shell bersama memakai default focus-visible global
           (editorial.css), konsisten dengan halaman siswa lainnya. */
        ...
        /* Sidebar/topbar/main-content responsif (transform, margin-left,
           padding) sudah ditangani shell bersama dashboard-shell-siswa.css.
           Hanya elemen page-specific (.badge-pill) yang perlu disembunyikan
           di sini, sama seperti siswa/profile/edit.blade.php. */
...
{{-- ================================================================
     MAIN CONTENT
================================================================ --}}
<main class="main-content" id="kontenPrestasi">
    ...
    <header class="topbar">
        <div style="display:flex; align-items:center; gap:14px; min-width:0;">
            ...
            <div class="topbar-title">
                ...
                <span class="topbar-crumb-current">Prestasi &amp; Sertifikat</span>
            </div>
        </div>
...
<script>
    ...
    // ── Escape menutup modal Tambah Prestasi/Sertifikat ──
    // (Escape untuk sidebar mobile ditangani oleh skrip shell bersama di bawah.)
    document.addEventListener('keydown', function (e) {
        if (e.key !== 'Escape') return;
        var modal = document.getElementById('achievementModal');
        if (modal && modal.classList.contains('open')) { closeAchievementModal(); }
    });
