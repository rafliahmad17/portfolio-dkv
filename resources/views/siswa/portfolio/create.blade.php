...
<head>
    ...
    <title>Unggah Karya — DKV SMEKDA Portal</title>
...
<div class="main-content">
    ...
    <div class="topbar">
        <div class="topbar-title">
            Portal DKV SMEKDA <span>/</span> Unggah Karya Baru
        </div>
    ...
    <div class="page-inner">
        ...
        <div style="margin-bottom:36px;">
            ...
            <h1 class="form-headline">
                Unggah <span class="hl">Karya Baru</span>
            </h1>
                    ...
                    <div class="form-card">
                        <div class="form-card-header">
                            ...
                            <div>
                                ...
                                <div class="card-header-sub">Gambar utama yang mewakili karya Anda</div>
                            </div>
                        </div>
                            ...
                            >
                                ...
                                <div class="preview-wrap" id="imagePreviewWrap">
                                    ...
                                    <div class="preview-overlay">
                                        ...
                                        <div class="preview-name" id="imageFileName"></div>
                                    </div>
                                    <div class="preview-badge" id="previewBadge">✓ Terpilih</div>
                                </div>
                            </div>
                    ...
                    <div class="form-card">
                        <div class="form-card-header">
                            ...
                            <div>
                                ...
                                <div class="card-header-sub">Lengkapi metadata karya Anda</div>
                            </div>
                        </div>
                        <div class="form-card-body">
                            ...
                            <div class="field-wrap">
                                <label class="field-label">
                                    File Dokumen PDF
                                    <span style="color:rgba(255,255,255,0.2); font-weight:500; text-transform:none; letter-spacing:0; margin-left:6px; font-size:0.65rem;">(Opsional)</span>
                                </label>
                                <div
...
<script>
    ...
    pdfInput.addEventListener('change', () => {
        ...
        if (file) {
            pdfTextMain.textContent = file.name;
